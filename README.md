...
A high-performance, fully responsive e-commerce web application engineered with **React**, **Redux Toolkit**, and **Tailwind CSS**. Featuring a premium deep navy dashboard design, a real-time global cart system, contextual state synchronization, and dynamic pricing metrics.
...
* **Interactive Promo Core:** Live client-side discount framework with real-time validation feedback loops (Use Code: `SAVE10`).
...
Features an elegant dual-layer data flow where complex array mutation logic is fully encapsulated inside a Redux Slice (`CartSlice`), while contextual hooks handle lightweight visual events without breaking structural separation.
